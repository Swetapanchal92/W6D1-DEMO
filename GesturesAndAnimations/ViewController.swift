...
//        rotateBox(radians: CGFloat.pi*CGFloat(timesRotated))
    ...
    func randomColor() -> UIColor {
        ...
        let randomColor = UIColor(displayP3Red: CGFloat(randomDecimal()), green: CGFloat(randomDecimal()), blue: CGFloat(randomDecimal()), alpha: 1.0)
        
        // UIColor(colorLiteralRed: randomDecimal(), green: randomDecimal(), blue: randomDecimal(), alpha: 1.0)
        return randomColor
    }
    ...
    @IBAction func longPressedRecognized(_ sender: Any) {
